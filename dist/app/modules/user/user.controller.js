...
const createParticipator = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.UserService.createParticipator(req);
...
const createHost = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.UserService.createHost(req);
    (0, sendResponse_1.default)(res, {
        statusCode: 201,
        success: true,
